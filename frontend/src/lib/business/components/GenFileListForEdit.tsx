...
interface GenFileListForEditProps {
  genFiles: components["schemas"]["GenFileDto"][];
  description: string;
  url: string;
}

export function GenFileListForEdit({
  genFiles,
  description,
  url,
}: GenFileListForEditProps) {
          ...
          {attachmentGenFiles.map((genFile) => (
            ...
            >
              ...
              <div className="flex flex-wrap">
                ...
                <Button variant="link" className="justify-start" asChild>
                  <Link href={`${url}/${genFile.id}/modify`}>
                    <Pencil />
                    <span>수정</span>
                  </Link>
                </Button>
                ...
                <Button variant="link" className="justify-start" asChild>
                  <Link href={`${url}/${genFile.id}/delete`}>
                    <Trash />
                    <span>삭제</span>
                  </Link>
                </Button>
