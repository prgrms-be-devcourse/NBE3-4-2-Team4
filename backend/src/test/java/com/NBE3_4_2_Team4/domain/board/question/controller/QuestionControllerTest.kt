...
class QuestionControllerTest {
    ...
    fun t3() {
        ...
        resultActions.andExpect(handler().handlerType(QuestionController::class.java))
                ...
                .andExpect(jsonPath("$.created_at").value(Matchers.startsWith(question.createdAt.toString().substring(0, 25))))
                .andExpect(jsonPath("$.modified_at").value(Matchers.startsWith(question.modifiedAt.toString().substring(0, 25))))
    ...
    fun t4_1() {
        ...
        resultActions.andExpect(handler().handlerType(QuestionController::class.java))
                ...
                .andExpect(jsonPath("$.data.item.created_at").value(Matchers.startsWith(question.createdAt.toString().substring(0, 25))))
                .andExpect(jsonPath("$.data.item.modified_at").value(Matchers.startsWith(question.modifiedAt.toString().substring(0, 25))))
    ...
    fun t14() {
        ...
        resultActions.andExpect(handler().handlerType(QuestionController::class.java))
                ...
                .andExpect(jsonPath("$.data.id").value(question.id))
                ...
                .andExpect(jsonPath("$.data.selected_answer.id").value(answer.id))
